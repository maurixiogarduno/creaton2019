...
var InfoService = /** @class */ (function () {
    function InfoService(db) {
        ...
        //PARAMAS COLECTION
        this.paramsCollection = db.collection('parametro');
        this.parametro = this.paramsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return __assign({ id: id }, data);
    ...
    //METODOS TODO
    InfoService.prototype.getTodos = function () {
        return this.todos;
    };
    InfoService.prototype.getTodo = function (id) {
        return this.todosCollection.doc(id).valueChanges();
    };
    //PUT TODO
    InfoService.prototype.updateTodo = function (todo, id) {
        return this.todosCollection.doc(id).update(todo);
    };
    //PUSH TODO
    InfoService.prototype.addTodo = function (todo) {
        return this.todosCollection.add(todo);
    };
    //DELETE TODO
    InfoService.prototype.removeTodo = function (id) {
        return this.todosCollection.doc(id).delete();
    };
    ////METODOS PARAMS
    InfoService.prototype.getParams = function () {
        return this.parametro;
    };
    InfoService.prototype.getParam = function (id) {
        return this.paramsCollection.doc(id).valueChanges();
    };
    //PUT TODO
    InfoService.prototype.updateParam = function (param, id) {
        return this.paramsCollection.doc(id).update(param);
    };
    //PUSH TODO
    InfoService.prototype.addParam = function (param) {
        return this.paramsCollection.add(param);
    };
    //DELETE TODO
    InfoService.prototype.removeParam = function (id) {
